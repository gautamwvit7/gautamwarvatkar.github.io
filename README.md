<!-- This is my resume, I'm going to build it up as I learn stuff -->
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body style="background-color: rgb(248,236,236)">
    <header style="background-color: #e8caca"> <img src="[https://climate.copernicus.eu/sites/default/files/styles/hero_image_extra_large_2x/public/2023-07/iStock-1267333118.jpg?itok=1udeNtwZ](https://drive.google.com/file/d/18jHtOLQKv_Uz99Oet1O_eKI7tRNSywtj/view?usp=sharing)" width="100%" height="500" alt="My photo">
        <br>
    ...
    <br>
    <div>
    <section><h2 > <a href="https://leetcode.com/user0165wK/" target="main">Skills </a></h2> </section>
    <div>
        <p>
    <ul>
        <li>C language</li>
        ...
        <div>
            <table> <tbody>
                ...
                <tr>
                    <td> HSC </td>
                    <td> 2020 </td>
                    <td> <a href="https://www.smvthane.srima.edu.in/" target="main">Sri Ma Vidyalaya  </a></td>
                    <td>I got 92.8 %. I have played in Football and took part in Maths Olympiad before 9th.</td>
                </tr>

                <tr >
                    <td> B.Tech </td>
                    <td> 2026 </td>
                    <td> <a href="https://www.vit.edu/" target="main">Vishwakarma Institute of Technology  </a></td>
                    <td>I got 9.25 CPA in First Year.</td>
                </tr>
